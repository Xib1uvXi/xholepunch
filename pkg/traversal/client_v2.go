...
func NewClientV2(serverAddr string, natType int8, holePunchHandler HolePunchHandler, connectFactory ConnectFactory) *ClientV2 {
...
func (c *ClientV2) HolePunching(token string) error {
...
// connect
func (c *ClientV2) connect(token string) (conn net.Conn, err error) {
	...
	c.closeFn = append(c.closeFn, func() { tcpConn.Close() })
...
func (c *ClientV2) negotiation(conn net.Conn) (*rendezvous.NegotiationMessage, error) {
	// set timeout
...
func (c *ClientV2) sendMsgToNewServerPort(msg *rendezvous.NegotiationMessage) error {
...
// getRemoteAddr
func (c *ClientV2) getRemoteAddr(conn net.Conn, remoteAddrCh chan string) {
